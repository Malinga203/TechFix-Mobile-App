...
public class RepairMedia {
    ...
    // Display values loaded from the related repair.
    ...
    public boolean isSample() {
        return TYPE_SAMPLE.equals(mediaType);
    }

    public boolean isProgress() {
        return TYPE_PROGRESS.equals(mediaType);
    }

    public String getReadableStage() {

        if (repairStage == null || repairStage.trim().isEmpty()) {
            return "Repair Update";
        }

        String value = repairStage
                .replace("_", " ")
